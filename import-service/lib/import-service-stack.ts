...
export class ImportServiceStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const importProductsFileLambda = new NodejsFunction(this, 'ImportProductsFilesFunction', {
    ...
    const importFileParserFunction = new NodejsFunction(this, 'ImportFilesParserFunction', {
